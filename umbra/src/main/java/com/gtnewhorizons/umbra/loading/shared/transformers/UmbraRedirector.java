...
/**
 * Mod-level wrapper around {@link GLSMRedirector}. Adds Umbra-specific transformer exclusions
 * and delegates all redirect logic to GLSM.
 * <p>
