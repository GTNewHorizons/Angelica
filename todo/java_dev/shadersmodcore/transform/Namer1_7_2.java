...
public class Namer1_7_2 extends Namer {
	...
	public void setNames() {
		...
		guiButton_id                = f(guiButton_       ,"field_146127_k",null);
		guiOptions_buttonList       = f(guiOptions_      ,"field_146292_n",null);
		guiOptions_width            = f(guiOptions_      ,"field_146294_l",null);
		guiOptions_height           = f(guiOptions_      ,"field_146295_m",null);
		guiOptions_mc               = f(guiOptions_      ,"field_146297_k",null);
		guiOptions_options          = f(guiOptions_      ,"field_146443_h",null);
		layeredTexture_layeredTextureNames = f(layeredTexture_,"field_110567_b",null);
		minecraft_renderGlobal      = f(minecraft_       ,"field_71438_f" ,null);
		minecraft_gameSettings      = f(minecraft_       ,"field_71474_y" ,null);
		modelRenderer_displayList   = f(modelRenderer_   ,"field_78811_r" ,null);
		modelRenderer_compiled      = f(modelRenderer_   ,"field_78812_q" ,null);
		renderGlobal_glSkyList      = f(renderGlobal_    ,"field_72771_w" ,null);
		...
		tessellator_floatBuffer     = f(tessellator_     ,"field_147566_d",null);
		tessellator_shortBuffer     = f(tessellator_     ,"field_147567_e",null);
		tessellator_intBuffer       = f(tessellator_     ,"field_147568_c",null);
		tessellator_byteBuffer      = f(tessellator_     ,"field_78394_d" ,null);
		tessellator_rawBuffer       = f(tessellator_     ,"field_78405_h" ,null);
		tessellator_vertexCount     = f(tessellator_     ,"field_78406_i" ,null);
		...
		block_getAoLight                   = m(block_          ,"func_149685_I","("+iBlockAccess_.desc+"III)F");
		...
		iResourceManager_getResource       = m(iResourceManager_,"func_110536_a","("+resourceLocation_.desc+")"+iResource_.desc);
		itemRenderer_renderItem            = m(itemRenderer_   ,"func_78443_a" ,"("+entityLivingBase_.desc+itemStack_.desc+"I)V");
		...
		renderBlocks_renderBlockSandFalling = m(renderBlocks_  ,"func_147749_a","("+block_.desc+world_.desc+"IIII)V");
		...
		rendererLivingE_renderLabel        = m(rendererLivingE_,"func_96449_a" ,"("+entityLivingBase_.desc+"DDDLjava/lang/String;FD)V");
		renderGlobal_renderEntities        = m(renderGlobal_   ,"func_147589_a","("+entityLivingBase_.desc+iCamera_.desc+"F)V");
		renderGlobal_renderSky             = m(renderGlobal_   ,"func_72714_a" ,"(F)V");
		renderGlobal_drawBlockDamageTexture = m(renderGlobal_  ,"func_72717_a" ,"("+tessellator_.desc+entityPlayer_.desc+"F)V");
		...
		renderGlobal_drawSelectionBox      = m(renderGlobal_   ,"func_72731_b" ,"("+entityPlayer_.desc+movingObjectPos_.desc+"IF)V");
		...
		textureManager_onResourceManagerReload = m(textureManager_,"func_110549_a","("+iResourceManager_.desc+")V");
		...
		textureMap_getIconResLoc           = m(textureMap_     ,"func_147634_a","("+resourceLocation_.desc+"I)"+resourceLocation_.desc);
		textureMap_updateAnimations        = m(textureMap_     ,"func_94248_c" ,"()V");
		textureUtil_uploadTexture          = m(textureUtil_    ,"func_110988_a","(I[III)V");
		textureUtil_uploadTextureImageAllocate = m(textureUtil_,"func_110989_a","(ILjava/awt/image/BufferedImage;ZZ)I");
		...
		worldClient_getCelestialAngle      = m(worldClient_    ,"func_72826_c" ,"(F)F");
		worldClient_getRainStrength        = m(worldClient_    ,"func_72867_j" ,"(F)F");
