...
public class Namer1_7_5 extends Namer {

	public void setNames() {
		setNames1_7_5();
	}
	public void setNames1_7_5() {
		block_            = c("aif");
		minecraft_        = c("azl");
		guiButton_        = c("bax");
		guiOptions_       = c("bce");
		guiScreen_        = c("bco");
		modelRenderer_    = c("bjy");
		worldClient_      = c("bkg");
		effectRenderer_   = c("bln");
		entityRenderer_   = c("bms");
		glAllocation_     = c("azk");
		itemRenderer_     = c("bmx");
		openGlHelper_     = c("bwq");
		renderBlocks_     = c("bml");
		renderGlobal_     = c("bmz");
		tessellator_      = c("bng");
		worldRenderer_    = c("bmn");
		frustrum_         = c("bnw");
		iCamera_          = c("bnu");
		render_           = c("bon");
		renderDragon_     = c("bok");
		renderEnderman_   = c("bol");
		renderSpider_     = c("bpu");
		renderManager_    = c("bom");
		rendererLivingE_  = c("bpg");
		abstractTexture_  = c("bqo");
		dynamicTexture_   = c("bqp");
		iTextureObject_   = c("brg");
		layeredTexture_   = c("bqs");
		simpleTexture_    = c("bqt");
		stitcher_         = c("bqu");
		textureAtlasSpri_ = c("brc");
		textureClock_     = c("brk");
		textureCompass_   = c("brl");
		textureManager_   = c("bre");
		textureMap_       = c("bqy");
		textureUtil_      = c("brh");
		textureDownload_  = c("bqq");
		iResource_        = c("brv");
		iResourceManager_ = c("brx");
		gameSettings_     = c("baf");
		tessVertexState_  = c("bnh");
		entity_           = c("qx");
		entityLivingBase_ = c("rs");
		entityDragon_     = c("vx");
		entityEnderman_   = c("wx");
		entitySpider_     = c("xk");
		entityPlayer_     = c("xw");
		itemBlock_        = c("aae");
		itemStack_        = c("aca");
		movingObjectPos_  = c("ayr");
		resourceLocation_ = c("brw");
		vec3_             = c("ayt");
		iBlockAccess_     = c("agi");
		world_            = c("afy");
		...
		tessellator_floatBuffer     = f(tessellator_     ,"f","Ljava/nio/FloatBuffer;");
