...
public class FinalPassRenderer {
	...
	public void renderFinalPass() {
		...
		for (SwapPass swapPass : swapPasses) {
			...
			// returns the *current eye's* RenderTarget, whereas a pre-captured texture ID would always
			// point at the eye that was active when the SwapPass was first built — causing each eye to
