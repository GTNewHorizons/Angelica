...
public class BooleanElementWidget extends BaseOptionElementWidget<OptionMenuBooleanOptionElement> {
	private static final Component TEXT_TRUE = I18n.format("label.iris.true").withStyle(ChatFormatting.GREEN);
	private static final Component TEXT_FALSE = I18n.format("label.iris.false").withStyle(ChatFormatting.RED);
	private static final Component TEXT_TRUE_DEFAULT = I18n.format("label.iris.true");
	private static final Component TEXT_FALSE_DEFAULT = I18n.format("label.iris.false");
