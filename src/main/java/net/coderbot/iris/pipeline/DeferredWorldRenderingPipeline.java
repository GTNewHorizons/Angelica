...
public class DeferredWorldRenderingPipeline implements WorldRenderingPipeline, RenderTargetStateListener  {
	...
	public DeferredWorldRenderingPipeline(ProgramSet programs) {
		...
		final com.gtnewhorizons.angelica.stereo.StereoState stereoState =
...
//		whitePixel.releaseId();
	...
	private void prepareRenderTargets() {
		...
		final com.gtnewhorizons.angelica.stereo.StereoState stereoResize =
			com.gtnewhorizons.angelica.stereo.StereoState.INSTANCE;
		...
		if (com.gtnewhorizons.angelica.stereo.StereoState.INSTANCE.isInWorldPass()
...
//		DimensionSpecialEffects.SkyType skyType = Minecraft.getMinecraft().theWorld.effects().skyType();
	...
	public void finalizeLevelRendering() {
		...
		final com.gtnewhorizons.angelica.stereo.StereoState stereoFinal =
			com.gtnewhorizons.angelica.stereo.StereoState.INSTANCE;
