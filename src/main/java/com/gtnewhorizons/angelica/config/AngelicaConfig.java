...
public class AngelicaConfig {
    ...
    @Config.DefaultStringList({
        "minecraft:dirt", "ExtraUtilities:cursedearthside", "TConstruct:CraftedSoil", "BiomesOPlenty:mud", "BiomesOPlenty:driedDirt", "BiomesOPlenty:newBopDirt", "BiomesOPlenty:hardDirt", "dreamcraft:SandClayMix", "Botania:dirtPath", "Botania:enchantedSoil", "Botany:soil", "Botany:loam", "Botany:soilNoWeed", "Botany:loamNoWeed", "etfuturum:coarse_dirt", "etfuturum:soul_soil", "MagicBees:magicbees.enchantedEarth", "witchery:pitdirt", "DraconicEvolution:earth", "GalaxySpace:barnardaCdirt", "GalaxySpace:barnardaEgrunt", "GalaxySpace:barnardaEsubgrunt", "GalaxySpace:barnardaFgrunt", "GalaxySpace:barnardaFsubgrunt", "GalaxySpace:vegabgrunt", "GalaxySpace:vegabsubgrunt", "RandomThings:fertilizedDirt", "ToxicEverglades:blockDarkWorldGround2", "minecraft:cobblestone", "minecraft:sandstone", "minecraft:mossy_cobblestone", "minecraft:end_stone", "minecraft:andesite", "minecraft:granite", "etfuturum:andesite", "etfuturum:granite", "IC2:blockBasalt", "ExtraUtilities:color_stone", "ExtraUtilities:cobblestone_compressed", "TConstruct:SpeedBlock", "BiomesOPlenty:stoneFormations", "BiomesOPlenty:ashStone", "BiomesOPlenty:cragRock", "Botania:livingrock", "Botania:prismarine", "Botania:shimmerrock", "Botania:biomeStoneA", "Botania:stone", "BloodArsenal:blood_stone", "etfuturum:smooth_stone", "etfuturum:deepslate", "etfuturum:cobbled_deepslate", "etfuturum:polished_deepslate", "etfuturum:tuff", "etfuturum:calcite", "etfuturum:blackstone", "etfuturum:gilded_blackstone", "gregtech:gt.blockgranites", "gregtech:gt.blockstones", "witchery:tormentstone", "Ztones:stoneTile", "thaumicbases:oldCobble", "thaumicbases:oldCobbleMossy", "ProjRed|Exploration:projectred.exploration.stone", "GalaxySpace:mercuryblocks", "GalaxySpace:venusblocks", "GalaxySpace:ceresblocks", "GalaxySpace:haumeablocks", "GalaxySpace:makemakegrunt", "GalaxySpace:phobosblocks", "GalaxySpace:deimosblocks", "GalaxySpace:ioblocks", "GalaxySpace:iodualstone", "GalaxySpace:europagrunt", "GalaxySpace:ganymedeblocks", "GalaxySpace:callistoblocks", "GalaxySpace:titanblocks", "GalaxySpace:mirandablocks", "GalaxySpace:oberonblocks", "GalaxySpace:proteusblocks", "GalaxySpace:tritonblocks", "GalaxySpace:acentauribbgrunt", "GalaxySpace:acentauribbsubgrunt", "GalaxySpace:tcetieblocks", "minecraft:sand", "minecraft:soul_sand", "ExtraUtilities:color_hellsand", "Natura:heatsand", "BiomesOPlenty:ash", "BiomesOPlenty:hardSand", "etfuturum:red_sandstone", "etfuturum:smooth_red_sandstone", "etfuturum:concrete_powder", "VillageNames:concretePowder", "minecraft:mycelium"
    })
    public static String[] naturalTextureBlocks = new String[] {
        "minecraft:dirt", "ExtraUtilities:cursedearthside", "TConstruct:CraftedSoil", "BiomesOPlenty:mud", "BiomesOPlenty:driedDirt", "BiomesOPlenty:newBopDirt", "BiomesOPlenty:hardDirt", "dreamcraft:SandClayMix", "Botania:dirtPath", "Botania:enchantedSoil", "Botany:soil", "Botany:loam", "Botany:soilNoWeed", "Botany:loamNoWeed", "etfuturum:coarse_dirt", "etfuturum:soul_soil", "MagicBees:magicbees.enchantedEarth", "witchery:pitdirt", "DraconicEvolution:earth", "GalaxySpace:barnardaCdirt", "GalaxySpace:barnardaEgrunt", "GalaxySpace:barnardaEsubgrunt", "GalaxySpace:barnardaFgrunt", "GalaxySpace:barnardaFsubgrunt", "GalaxySpace:vegabgrunt", "GalaxySpace:vegabsubgrunt", "RandomThings:fertilizedDirt", "ToxicEverglades:blockDarkWorldGround2", "minecraft:cobblestone", "minecraft:sandstone", "minecraft:mossy_cobblestone", "minecraft:end_stone", "minecraft:andesite", "minecraft:granite", "etfuturum:andesite", "etfuturum:granite", "IC2:blockBasalt", "ExtraUtilities:color_stone", "ExtraUtilities:cobblestone_compressed", "TConstruct:SpeedBlock", "BiomesOPlenty:stoneFormations", "BiomesOPlenty:ashStone", "BiomesOPlenty:cragRock", "Botania:livingrock", "Botania:prismarine", "Botania:shimmerrock", "Botania:biomeStoneA", "Botania:stone", "BloodArsenal:blood_stone", "etfuturum:smooth_stone", "etfuturum:deepslate", "etfuturum:cobbled_deepslate", "etfuturum:polished_deepslate", "etfuturum:tuff", "etfuturum:calcite", "etfuturum:blackstone", "etfuturum:gilded_blackstone", "gregtech:gt.blockgranites", "witchery:tormentstone", "Ztones:stoneTile", "thaumicbases:oldCobble", "thaumicbases:oldCobbleMossy", "ProjRed|Exploration:projectred.exploration.stone", "GalaxySpace:mercuryblocks", "GalaxySpace:venusblocks", "GalaxySpace:ceresblocks", "GalaxySpace:haumeablocks", "GalaxySpace:makemakegrunt", "GalaxySpace:phobosblocks", "GalaxySpace:deimosblocks", "GalaxySpace:ioblocks", "GalaxySpace:iodualstone", "GalaxySpace:europagrunt", "GalaxySpace:ganymedeblocks", "GalaxySpace:callistoblocks", "GalaxySpace:titanblocks", "GalaxySpace:mirandablocks", "GalaxySpace:oberonblocks", "GalaxySpace:proteusblocks", "GalaxySpace:tritonblocks", "GalaxySpace:acentauribbgrunt", "GalaxySpace:acentauribbsubgrunt", "GalaxySpace:tcetieblocks", "minecraft:sand", "minecraft:soul_sand", "ExtraUtilities:color_hellsand", "Natura:heatsand", "BiomesOPlenty:ash", "BiomesOPlenty:hardSand", "etfuturum:red_sandstone", "etfuturum:smooth_red_sandstone", "etfuturum:concrete_powder", "VillageNames:concretePowder", "minecraft:mycelium"
    };
