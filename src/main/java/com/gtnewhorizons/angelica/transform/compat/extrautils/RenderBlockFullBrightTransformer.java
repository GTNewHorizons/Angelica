...
public class RenderBlockFullBrightTransformer implements IClassTransformer {

    @Override
    public byte[] transform(String name, String transformedName, byte[] basicClass) {
        if (transformedName.equals("com.rwtema.extrautils.block.render.RenderBlockFullBright")) {
