...
import static com.gtnewhorizons.angelica.models.VanillaModels.GLASS;

@Mixin(BlockGlass.class)
public abstract class MixinBlockGlass implements QuadProvider {
    ...
    public List<QuadView> getQuads(IBlockAccess world, BlockPos pos, Block block, int meta, ForgeDirection dir, Random random, int color, Supplier<QuadView> quadPool) {
        return GLASS.getQuads(world, pos, block, meta, dir, random, color, quadPool);
    }
}
