...
public class DynamicLights {
    ...
    public static double maxDynamicLightLevel(@NotNull BlockPosImpl pos, @NotNull IDynamicLightSource lightSource, double currentLightLevel) {
        ...
        if (luminance > 0) {
            ...
            double dx = pos.getX() - lightSource.angelica$getDynamicLightX() + 0.5;
            double dy = pos.getY() - lightSource.angelica$getDynamicLightY() + 0.5;
            double dz = pos.getZ() - lightSource.angelica$getDynamicLightZ() + 0.5;
