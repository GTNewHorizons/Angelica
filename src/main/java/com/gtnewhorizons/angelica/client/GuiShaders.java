    ...
    */
    ...
    public void initGui() {
        ...
        buttonList.add(new GuiButton(
                17, width * 3 / 4 - 60, 30, 160, 18, "NormapMap: " + toStringOnOff(Shaders.configNormalMap)));
        buttonList.add(new GuiButton(
                18, width * 3 / 4 - 60, 50, 160, 18, "SpecularMap: " + toStringOnOff(Shaders.configSpecularMap)));
        buttonList.add(new GuiButton(
                15,
                width * 3 / 4 - 60,
                70,
        ...
        buttonList.add(new GuiButton(
                9, width * 3 / 4 - 60, 130, 160, 18, "CloudShadow: " + toStringOnOff(Shaders.configCloudShadow)));
        ...
        buttonList.add(new GuiButton(
                19, width * 3 / 4 - 60, 190, 160, 18, "OldLighting: " + toStringOnOff(Shaders.configOldLighting)));
                ...
                case 5: /* Open shaderpacks folder */
                        ...
                        case OSX:
                            {
                                try {
                                    Runtime.getRuntime().exec(new String[] {
                                        "/usr/bin/open", Shaders.shaderpacksdir.getAbsolutePath()
                                    });
                                    return;
                    ...
                    try {
                        ...
                        var3.getMethod("browse", new Class[] {URI.class})
                                .invoke(var4, new Object[] {(new File(mc.mcDataDir, Shaders.shaderpacksdirname)).toURI()
                                });
