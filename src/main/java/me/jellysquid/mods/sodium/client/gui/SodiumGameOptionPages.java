    ...
    public static OptionPage performance() {
        ...
        groups.add(OptionGroup.createBuilder()
                ...
                .add(OptionImpl.createBuilder(int.class, angelicaOpts)
                        .setName(I18n.format("options.angelica.fsrRenderScale"))
                        .setTooltip(I18n.format("options.angelica.fsrRenderScale.tooltip"))
                        .setControl(o -> new SliderControl(o, 50, 100, 1, ControlValueFormatter.percentage()))
                        .setImpact(OptionImpact.HIGH)
                        .setBinding((opts, value) -> AngelicaConfig.fsrRenderScale = value, opts -> AngelicaConfig.fsrRenderScale)
                        .build()
                )
                .add(OptionImpl.createBuilder(int.class, angelicaOpts)
                        .setName(I18n.format("options.angelica.fsrSharpness"))
                        .setTooltip(I18n.format("options.angelica.fsrSharpness.tooltip"))
                        .setControl(o -> new SliderControl(o, 0, 100, 5, ControlValueFormatter.percentage()))
                        .setImpact(OptionImpact.LOW)
                        .setBinding((opts, value) -> AngelicaConfig.fsrSharpness = value, opts -> AngelicaConfig.fsrSharpness)
                        .build()
                )
