...
public class SodiumGameOptionPages {
    ...
    public static OptionPage performance() {
        ...
        groups.add(OptionGroup.createBuilder()
                ...
                .add(OptionImpl.createBuilder(boolean.class, angelicaOpts)
                        .setName(I18n.format("options.angelica.multipartPassFix"))
                        .setTooltip(I18n.format("options.angelica.multipartPassFix.tooltip"))
                        .setControl(TickBoxControl::new)
                        .setImpact(OptionImpact.LOW)
                        .setBinding((opts, value) -> AngelicaConfig.fixMultipartPassRace = value, opts -> AngelicaConfig.fixMultipartPassRace)
                        .setFlags(OptionFlag.REQUIRES_RENDERER_RELOAD)
                        .build()
                )
