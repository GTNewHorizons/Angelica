    ...
    public static OptionPage text() {
        ...
        groups.add(OptionGroup.createBuilder()
                .add(OptionImpl.createBuilder(boolean.class, angelicaOpts)
                        ...
                        .setTooltip(I18n.format("options.angelica.texteffects.rgb_colors.tooltip"))
                        .setControl(TickBoxControl::new)
                ...
                .add(OptionImpl.createBuilder(boolean.class, angelicaOpts)
                        ...
                        .setTooltip(I18n.format("options.angelica.texteffects.gradients.tooltip"))
                        .setControl(TickBoxControl::new)
                ...
                .add(OptionImpl.createBuilder(boolean.class, angelicaOpts)
                        ...
                        .setTooltip(I18n.format("options.angelica.texteffects.rainbow.tooltip"))
                        .setControl(TickBoxControl::new)
                ...
                .add(OptionImpl.createBuilder(boolean.class, angelicaOpts)
                        ...
                        .setTooltip(I18n.format("options.angelica.texteffects.wave_text.tooltip"))
                        .setControl(TickBoxControl::new)
                ...
                .add(OptionImpl.createBuilder(boolean.class, angelicaOpts)
                        ...
                        .setTooltip(I18n.format("options.angelica.texteffects.dinnerbone_text.tooltip"))
                        .setControl(TickBoxControl::new)
                ...
                .add(OptionImpl.createBuilder(boolean.class, angelicaOpts)
                        ...
                        .setTooltip(I18n.format("options.angelica.texteffects.drop_shadow.tooltip"))
                        .setControl(TickBoxControl::new)
