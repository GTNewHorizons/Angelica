    ...
    public static OptionPage performance() {
        ...
        groups.add(OptionGroup.createBuilder()
                ...
                .add(OptionImpl.createBuilder(int.class, angelicaOpts)
                        .setName(I18n.format("options.angelica.tesrRenderDistance"))
                        .setTooltip(I18n.format("options.angelica.tesrRenderDistance.tooltip"))
                        .setControl(o -> new SliderControl(o, 0, 64, 8, ControlValueFormatter.quantityOrDisabled("options.angelica.tesrRenderDistance.value", "options.angelica.unlimited")))
                        .setImpact(OptionImpact.HIGH)
                        .setBinding((opts, value) -> AngelicaConfig.tesrRenderDistance = value, opts -> AngelicaConfig.tesrRenderDistance)
                        .build()
                )
