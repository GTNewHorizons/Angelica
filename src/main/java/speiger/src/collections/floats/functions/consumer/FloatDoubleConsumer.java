...
public interface FloatDoubleConsumer extends BiConsumer<Float, Double>
{
	 ...
	 */
	public default FloatDoubleConsumer andThen(FloatDoubleConsumer after) {
	...
	@Override
	@Deprecated
	default void accept(Float k, Double v) { accept(k.floatValue(), v.doubleValue()); }
	...
	@Override
	@Deprecated
	default FloatDoubleConsumer andThen(BiConsumer<? super Float, ? super Double> after) {
		Objects.requireNonNull(after);
		return (K, V) -> {accept(K, V); after.accept(Float.valueOf(K), Double.valueOf(V));};
	}
}