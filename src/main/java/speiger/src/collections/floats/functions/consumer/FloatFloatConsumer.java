 ...
 */
public interface FloatFloatConsumer extends BiConsumer<Float, Float>
{
	/**
	 ...
	 */
	public default FloatFloatConsumer andThen(FloatFloatConsumer after) {
	...
	@Override
	@Deprecated
	default void accept(Float k, Float v) { accept(k.floatValue(), v.floatValue()); }
	...
	@Override
	@Deprecated
	default FloatFloatConsumer andThen(BiConsumer<? super Float, ? super Float> after) {
		Objects.requireNonNull(after);
		return (K, V) -> {accept(K, V); after.accept(Float.valueOf(K), Float.valueOf(V));};
	}
}