...
public interface FloatIntConsumer extends BiConsumer<Float, Integer>
{
	 ...
	 */
	public default FloatIntConsumer andThen(FloatIntConsumer after) {
	...
	@Override
	@Deprecated
	default void accept(Float k, Integer v) { accept(k.floatValue(), v.intValue()); }
	...
	@Override
	@Deprecated
	default FloatIntConsumer andThen(BiConsumer<? super Float, ? super Integer> after) {
		Objects.requireNonNull(after);
		return (K, V) -> {accept(K, V); after.accept(Float.valueOf(K), Integer.valueOf(V));};
	}
}