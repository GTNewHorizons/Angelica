...
public interface FloatUnaryOperator
{
	 ...
	 */
	public float applyAsFloat(float k);
	 ...
	 */
	public default FloatUnaryOperator compose(FloatUnaryOperator before) {
     ...
     * @return a composed function with a different starting function.
	 */
	public default FloatUnaryOperator andThen(FloatUnaryOperator after) {
