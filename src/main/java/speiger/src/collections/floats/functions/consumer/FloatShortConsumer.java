...
public interface FloatShortConsumer extends BiConsumer<Float, Short>
{
	 ...
	 */
	public default FloatShortConsumer andThen(FloatShortConsumer after) {
	...
	@Override
	@Deprecated
	default void accept(Float k, Short v) { accept(k.floatValue(), v.shortValue()); }
	...
	@Override
	@Deprecated
	default FloatShortConsumer andThen(BiConsumer<? super Float, ? super Short> after) {
		Objects.requireNonNull(after);
		return (K, V) -> {accept(K, V); after.accept(Float.valueOf(K), Short.valueOf(V));};
	}
}