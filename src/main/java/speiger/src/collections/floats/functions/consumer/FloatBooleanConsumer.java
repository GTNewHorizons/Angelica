...
public interface FloatBooleanConsumer extends BiConsumer<Float, Boolean>
{
	 ...
	 */
	public default FloatBooleanConsumer andThen(FloatBooleanConsumer after) {
	...
	@Override
	@Deprecated
	default void accept(Float k, Boolean v) { accept(k.floatValue(), v.booleanValue()); }
	...
	@Override
	@Deprecated
	default FloatBooleanConsumer andThen(BiConsumer<? super Float, ? super Boolean> after) {
		Objects.requireNonNull(after);
		return (K, V) -> {accept(K, V); after.accept(Float.valueOf(K), Boolean.valueOf(V));};
	}
}