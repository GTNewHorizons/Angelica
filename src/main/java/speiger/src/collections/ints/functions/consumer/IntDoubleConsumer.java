...
public interface IntDoubleConsumer extends BiConsumer<Integer, Double>
{
	 ...
	 */
	public default IntDoubleConsumer andThen(IntDoubleConsumer after) {
	...
	@Override
	@Deprecated
	default void accept(Integer k, Double v) { accept(k.intValue(), v.doubleValue()); }
	...
	@Override
	@Deprecated
	default IntDoubleConsumer andThen(BiConsumer<? super Integer, ? super Double> after) {
		Objects.requireNonNull(after);
		return (K, V) -> {accept(K, V); after.accept(Integer.valueOf(K), Double.valueOf(V));};
	}
}