...
public interface IntCharConsumer extends BiConsumer<Integer, Character>
{
	 ...
	 */
	public default IntCharConsumer andThen(IntCharConsumer after) {
	...
	@Override
	@Deprecated
	default void accept(Integer k, Character v) { accept(k.intValue(), v.charValue()); }
	...
	@Override
	@Deprecated
	default IntCharConsumer andThen(BiConsumer<? super Integer, ? super Character> after) {
		Objects.requireNonNull(after);
		return (K, V) -> {accept(K, V); after.accept(Integer.valueOf(K), Character.valueOf(V));};
	}
}