...
public interface IntLongConsumer extends BiConsumer<Integer, Long>
{
	 ...
	 */
	public default IntLongConsumer andThen(IntLongConsumer after) {
	...
	@Override
	@Deprecated
	default void accept(Integer k, Long v) { accept(k.intValue(), v.longValue()); }
	...
	@Override
	@Deprecated
	default IntLongConsumer andThen(BiConsumer<? super Integer, ? super Long> after) {
		Objects.requireNonNull(after);
		return (K, V) -> {accept(K, V); after.accept(Integer.valueOf(K), Long.valueOf(V));};
	}
}