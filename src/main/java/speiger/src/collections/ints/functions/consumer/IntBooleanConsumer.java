...
public interface IntBooleanConsumer extends BiConsumer<Integer, Boolean>
{
	 ...
	 */
	public default IntBooleanConsumer andThen(IntBooleanConsumer after) {
	...
	@Override
	@Deprecated
	default void accept(Integer k, Boolean v) { accept(k.intValue(), v.booleanValue()); }
	...
	@Override
	@Deprecated
	default IntBooleanConsumer andThen(BiConsumer<? super Integer, ? super Boolean> after) {
		Objects.requireNonNull(after);
		return (K, V) -> {accept(K, V); after.accept(Integer.valueOf(K), Boolean.valueOf(V));};
	}
}