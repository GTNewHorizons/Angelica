...
public interface IntObjectConsumer<V> extends BiConsumer<Integer, V>
{
	 ...
	 */
	public default IntObjectConsumer<V> andThen(IntObjectConsumer<V> after) {
	...
	@Override
	@Deprecated
	default void accept(Integer k, V v) { accept(k.intValue(), v); }
	...
	@Override
	@Deprecated
	default IntObjectConsumer<V> andThen(BiConsumer<? super Integer, ? super V> after) {
		Objects.requireNonNull(after);
		return (K, V) -> {accept(K, V); after.accept(Integer.valueOf(K), V);};
	}
}