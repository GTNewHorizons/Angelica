...
public interface IntShortConsumer extends BiConsumer<Integer, Short>
{
	 ...
	 */
	public default IntShortConsumer andThen(IntShortConsumer after) {
	...
	@Override
	@Deprecated
	default void accept(Integer k, Short v) { accept(k.intValue(), v.shortValue()); }
	...
	@Override
	@Deprecated
	default IntShortConsumer andThen(BiConsumer<? super Integer, ? super Short> after) {
		Objects.requireNonNull(after);
		return (K, V) -> {accept(K, V); after.accept(Integer.valueOf(K), Short.valueOf(V));};
	}
}