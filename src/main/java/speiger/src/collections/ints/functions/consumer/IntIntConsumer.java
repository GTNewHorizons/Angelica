...
public interface IntIntConsumer extends BiConsumer<Integer, Integer>
{
	 ...
	 */
	public default IntIntConsumer andThen(IntIntConsumer after) {
	...
	@Override
	@Deprecated
	default void accept(Integer k, Integer v) { accept(k.intValue(), v.intValue()); }
	...
	@Override
	@Deprecated
	default IntIntConsumer andThen(BiConsumer<? super Integer, ? super Integer> after) {
		Objects.requireNonNull(after);
		return (K, V) -> {accept(K, V); after.accept(Integer.valueOf(K), Integer.valueOf(V));};
	}
}