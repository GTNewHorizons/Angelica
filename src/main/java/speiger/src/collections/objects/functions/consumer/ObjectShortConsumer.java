...
public interface ObjectShortConsumer<T> extends BiConsumer<T, Short>
{
	 ...
	 */
	public default ObjectShortConsumer<T> andThen(ObjectShortConsumer<T> after) {
	...
	@Override
	@Deprecated
	default void accept(T k, Short v) { accept(k, v.shortValue()); }
	...
	@Override
	@Deprecated
	default ObjectShortConsumer<T> andThen(BiConsumer<? super T, ? super Short> after) {
		Objects.requireNonNull(after);
		return (K, V) -> {accept(K, V); after.accept(K, Short.valueOf(V));};
	}
}