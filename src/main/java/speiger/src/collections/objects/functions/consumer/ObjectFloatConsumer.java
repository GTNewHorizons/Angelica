...
public interface ObjectFloatConsumer<T> extends BiConsumer<T, Float>
{
	 ...
	 */
	public default ObjectFloatConsumer<T> andThen(ObjectFloatConsumer<T> after) {
	...
	@Override
	@Deprecated
	default void accept(T k, Float v) { accept(k, v.floatValue()); }
	...
	@Override
	@Deprecated
	default ObjectFloatConsumer<T> andThen(BiConsumer<? super T, ? super Float> after) {
		Objects.requireNonNull(after);
		return (K, V) -> {accept(K, V); after.accept(K, Float.valueOf(V));};
	}
}