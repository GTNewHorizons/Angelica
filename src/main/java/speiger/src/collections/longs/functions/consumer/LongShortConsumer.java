 ...
 */
public interface LongShortConsumer extends BiConsumer<Long, Short>
{
	/**
	 ...
	 */
	public default LongShortConsumer andThen(LongShortConsumer after) {
	...
	@Override
	@Deprecated
	default void accept(Long k, Short v) { accept(k.longValue(), v.shortValue()); }
	...
	@Override
	@Deprecated
	default LongShortConsumer andThen(BiConsumer<? super Long, ? super Short> after) {
		Objects.requireNonNull(after);
		return (K, V) -> {accept(K, V); after.accept(Long.valueOf(K), Short.valueOf(V));};
	}
}