...
public interface LongFloatConsumer extends BiConsumer<Long, Float>
{
	 ...
	 */
	public default LongFloatConsumer andThen(LongFloatConsumer after) {
	...
	@Override
	@Deprecated
	default void accept(Long k, Float v) { accept(k.longValue(), v.floatValue()); }
	...
	@Override
	@Deprecated
	default LongFloatConsumer andThen(BiConsumer<? super Long, ? super Float> after) {
		Objects.requireNonNull(after);
		return (K, V) -> {accept(K, V); after.accept(Long.valueOf(K), Float.valueOf(V));};
	}
}