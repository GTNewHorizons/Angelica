...
public interface LongDoubleConsumer extends BiConsumer<Long, Double>
{
	 ...
	 */
	public default LongDoubleConsumer andThen(LongDoubleConsumer after) {
	...
	@Override
	@Deprecated
	default void accept(Long k, Double v) { accept(k.longValue(), v.doubleValue()); }
	...
	@Override
	@Deprecated
	default LongDoubleConsumer andThen(BiConsumer<? super Long, ? super Double> after) {
		Objects.requireNonNull(after);
		return (K, V) -> {accept(K, V); after.accept(Long.valueOf(K), Double.valueOf(V));};
	}
}