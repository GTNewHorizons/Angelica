 ...
 */
public interface LongCharConsumer extends BiConsumer<Long, Character>
{
	/**
	 ...
	 */
	public default LongCharConsumer andThen(LongCharConsumer after) {
	...
	@Override
	@Deprecated
	default void accept(Long k, Character v) { accept(k.longValue(), v.charValue()); }
	...
	@Override
	@Deprecated
	default LongCharConsumer andThen(BiConsumer<? super Long, ? super Character> after) {
		Objects.requireNonNull(after);
		return (K, V) -> {accept(K, V); after.accept(Long.valueOf(K), Character.valueOf(V));};
	}
}