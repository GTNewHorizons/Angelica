...
public interface LongLongConsumer extends BiConsumer<Long, Long>
{
	 ...
	 */
	public default LongLongConsumer andThen(LongLongConsumer after) {
	...
	@Override
	@Deprecated
	default void accept(Long k, Long v) { accept(k.longValue(), v.longValue()); }
	...
	@Override
	@Deprecated
	default LongLongConsumer andThen(BiConsumer<? super Long, ? super Long> after) {
		Objects.requireNonNull(after);
		return (K, V) -> {accept(K, V); after.accept(Long.valueOf(K), Long.valueOf(V));};
	}
}