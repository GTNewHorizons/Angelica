 ...
 */
public interface LongBooleanConsumer extends BiConsumer<Long, Boolean>
{
	/**
	 ...
	 */
	public default LongBooleanConsumer andThen(LongBooleanConsumer after) {
	...
	@Override
	@Deprecated
	default void accept(Long k, Boolean v) { accept(k.longValue(), v.booleanValue()); }
	...
	@Override
	@Deprecated
	default LongBooleanConsumer andThen(BiConsumer<? super Long, ? super Boolean> after) {
		Objects.requireNonNull(after);
		return (K, V) -> {accept(K, V); after.accept(Long.valueOf(K), Boolean.valueOf(V));};
	}
}