...
public interface CharIntConsumer extends BiConsumer<Character, Integer>
{
	 ...
	 */
	public default CharIntConsumer andThen(CharIntConsumer after) {
	...
	@Override
	@Deprecated
	default void accept(Character k, Integer v) { accept(k.charValue(), v.intValue()); }
	...
	@Override
	@Deprecated
	default CharIntConsumer andThen(BiConsumer<? super Character, ? super Integer> after) {
		Objects.requireNonNull(after);
		return (K, V) -> {accept(K, V); after.accept(Character.valueOf(K), Integer.valueOf(V));};
	}
}