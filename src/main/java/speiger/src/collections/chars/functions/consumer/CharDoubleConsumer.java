 ...
 */
public interface CharDoubleConsumer extends BiConsumer<Character, Double>
{
	/**
	 ...
	 */
	public default CharDoubleConsumer andThen(CharDoubleConsumer after) {
	...
	@Override
	@Deprecated
	default void accept(Character k, Double v) { accept(k.charValue(), v.doubleValue()); }
	...
	@Override
	@Deprecated
	default CharDoubleConsumer andThen(BiConsumer<? super Character, ? super Double> after) {
		Objects.requireNonNull(after);
		return (K, V) -> {accept(K, V); after.accept(Character.valueOf(K), Double.valueOf(V));};
	}
}