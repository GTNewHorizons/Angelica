 ...
 */
public interface CharCharConsumer extends BiConsumer<Character, Character>
{
	/**
	 ...
	 */
	public default CharCharConsumer andThen(CharCharConsumer after) {
	...
	@Override
	@Deprecated
	default void accept(Character k, Character v) { accept(k.charValue(), v.charValue()); }
	...
	@Override
	@Deprecated
	default CharCharConsumer andThen(BiConsumer<? super Character, ? super Character> after) {
		Objects.requireNonNull(after);
		return (K, V) -> {accept(K, V); after.accept(Character.valueOf(K), Character.valueOf(V));};
	}
}