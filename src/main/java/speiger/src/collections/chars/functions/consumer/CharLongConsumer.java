...
public interface CharLongConsumer extends BiConsumer<Character, Long>
{
	 ...
	 */
	public default CharLongConsumer andThen(CharLongConsumer after) {
	...
	@Override
	@Deprecated
	default void accept(Character k, Long v) { accept(k.charValue(), v.longValue()); }
	...
	@Override
	@Deprecated
	default CharLongConsumer andThen(BiConsumer<? super Character, ? super Long> after) {
		Objects.requireNonNull(after);
		return (K, V) -> {accept(K, V); after.accept(Character.valueOf(K), Long.valueOf(V));};
	}
}