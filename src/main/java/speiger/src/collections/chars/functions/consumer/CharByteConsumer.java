...
public interface CharByteConsumer extends BiConsumer<Character, Byte>
{
	 ...
	 */
	public default CharByteConsumer andThen(CharByteConsumer after) {
	...
	@Override
	@Deprecated
	default void accept(Character k, Byte v) { accept(k.charValue(), v.byteValue()); }
	...
	@Override
	@Deprecated
	default CharByteConsumer andThen(BiConsumer<? super Character, ? super Byte> after) {
		Objects.requireNonNull(after);
		return (K, V) -> {accept(K, V); after.accept(Character.valueOf(K), Byte.valueOf(V));};
	}
}