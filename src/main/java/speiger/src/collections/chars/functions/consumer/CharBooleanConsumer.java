 ...
 */
public interface CharBooleanConsumer extends BiConsumer<Character, Boolean>
{
	/**
	 ...
	 */
	public default CharBooleanConsumer andThen(CharBooleanConsumer after) {
	...
	@Override
	@Deprecated
	default void accept(Character k, Boolean v) { accept(k.charValue(), v.booleanValue()); }
	...
	@Override
	@Deprecated
	default CharBooleanConsumer andThen(BiConsumer<? super Character, ? super Boolean> after) {
		Objects.requireNonNull(after);
		return (K, V) -> {accept(K, V); after.accept(Character.valueOf(K), Boolean.valueOf(V));};
	}
}