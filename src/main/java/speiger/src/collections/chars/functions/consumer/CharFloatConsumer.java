...
public interface CharFloatConsumer extends BiConsumer<Character, Float>
{
	 ...
	 */
	public default CharFloatConsumer andThen(CharFloatConsumer after) {
	...
	@Override
	@Deprecated
	default void accept(Character k, Float v) { accept(k.charValue(), v.floatValue()); }
	...
	@Override
	@Deprecated
	default CharFloatConsumer andThen(BiConsumer<? super Character, ? super Float> after) {
		Objects.requireNonNull(after);
		return (K, V) -> {accept(K, V); after.accept(Character.valueOf(K), Float.valueOf(V));};
	}
}