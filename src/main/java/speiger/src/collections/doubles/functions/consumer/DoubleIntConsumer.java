...
public interface DoubleIntConsumer extends BiConsumer<Double, Integer>
{
	 ...
	 */
	public default DoubleIntConsumer andThen(DoubleIntConsumer after) {
	...
	@Override
	@Deprecated
	default void accept(Double k, Integer v) { accept(k.doubleValue(), v.intValue()); }
	...
	@Override
	@Deprecated
	default DoubleIntConsumer andThen(BiConsumer<? super Double, ? super Integer> after) {
		Objects.requireNonNull(after);
		return (K, V) -> {accept(K, V); after.accept(Double.valueOf(K), Integer.valueOf(V));};
	}
}