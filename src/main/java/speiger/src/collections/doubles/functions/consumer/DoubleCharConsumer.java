 ...
 */
public interface DoubleCharConsumer extends BiConsumer<Double, Character>
{
	/**
	 ...
	 */
	public default DoubleCharConsumer andThen(DoubleCharConsumer after) {
	...
	@Override
	@Deprecated
	default void accept(Double k, Character v) { accept(k.doubleValue(), v.charValue()); }
	...
	@Override
	@Deprecated
	default DoubleCharConsumer andThen(BiConsumer<? super Double, ? super Character> after) {
		Objects.requireNonNull(after);
		return (K, V) -> {accept(K, V); after.accept(Double.valueOf(K), Character.valueOf(V));};
	}
}