 ...
 */
public interface DoubleFloatConsumer extends BiConsumer<Double, Float>
{
	/**
	 ...
	 */
	public default DoubleFloatConsumer andThen(DoubleFloatConsumer after) {
	...
	@Override
	@Deprecated
	default void accept(Double k, Float v) { accept(k.doubleValue(), v.floatValue()); }
	...
	@Override
	@Deprecated
	default DoubleFloatConsumer andThen(BiConsumer<? super Double, ? super Float> after) {
		Objects.requireNonNull(after);
		return (K, V) -> {accept(K, V); after.accept(Double.valueOf(K), Float.valueOf(V));};
	}
}