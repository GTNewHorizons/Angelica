...
public interface DoubleBooleanConsumer extends BiConsumer<Double, Boolean>
{
	 ...
	 */
	void accept(double k, boolean v);
	 ...
	 */
	public default DoubleBooleanConsumer andThen(DoubleBooleanConsumer after) {
	...
	@Override
	@Deprecated
	default void accept(Double k, Boolean v) { accept(k.doubleValue(), v.booleanValue()); }
	...
	@Override
	@Deprecated
	default DoubleBooleanConsumer andThen(BiConsumer<? super Double, ? super Boolean> after) {
		Objects.requireNonNull(after);
		return (K, V) -> {accept(K, V); after.accept(Double.valueOf(K), Boolean.valueOf(V));};
	}
}