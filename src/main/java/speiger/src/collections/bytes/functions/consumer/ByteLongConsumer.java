...
public interface ByteLongConsumer extends BiConsumer<Byte, Long>
{
	 ...
	 */
	public default ByteLongConsumer andThen(ByteLongConsumer after) {
	...
	@Override
	@Deprecated
	default void accept(Byte k, Long v) { accept(k.byteValue(), v.longValue()); }
	...
	@Override
	@Deprecated
	default ByteLongConsumer andThen(BiConsumer<? super Byte, ? super Long> after) {
		Objects.requireNonNull(after);
		return (K, V) -> {accept(K, V); after.accept(Byte.valueOf(K), Long.valueOf(V));};
	}
}