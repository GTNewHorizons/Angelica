...
public interface ByteIntConsumer extends BiConsumer<Byte, Integer>
{
	 ...
	 */
	public default ByteIntConsumer andThen(ByteIntConsumer after) {
	...
	@Override
	@Deprecated
	default void accept(Byte k, Integer v) { accept(k.byteValue(), v.intValue()); }
	...
	@Override
	@Deprecated
	default ByteIntConsumer andThen(BiConsumer<? super Byte, ? super Integer> after) {
		Objects.requireNonNull(after);
		return (K, V) -> {accept(K, V); after.accept(Byte.valueOf(K), Integer.valueOf(V));};
	}
}