 ...
 */
public interface ByteByteConsumer extends BiConsumer<Byte, Byte>
{
	/**
	 ...
	 */
	public default ByteByteConsumer andThen(ByteByteConsumer after) {
	...
	@Override
	@Deprecated
	default void accept(Byte k, Byte v) { accept(k.byteValue(), v.byteValue()); }
	...
	@Override
	@Deprecated
	default ByteByteConsumer andThen(BiConsumer<? super Byte, ? super Byte> after) {
		Objects.requireNonNull(after);
		return (K, V) -> {accept(K, V); after.accept(Byte.valueOf(K), Byte.valueOf(V));};
	}
}