...
public interface ByteFloatConsumer extends BiConsumer<Byte, Float>
{
	 ...
	 */
	public default ByteFloatConsumer andThen(ByteFloatConsumer after) {
	...
	@Override
	@Deprecated
	default void accept(Byte k, Float v) { accept(k.byteValue(), v.floatValue()); }
	...
	@Override
	@Deprecated
	default ByteFloatConsumer andThen(BiConsumer<? super Byte, ? super Float> after) {
		Objects.requireNonNull(after);
		return (K, V) -> {accept(K, V); after.accept(Byte.valueOf(K), Float.valueOf(V));};
	}
}