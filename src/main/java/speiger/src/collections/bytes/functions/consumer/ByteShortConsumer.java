...
public interface ByteShortConsumer extends BiConsumer<Byte, Short>
{
	 ...
	 */
	public default ByteShortConsumer andThen(ByteShortConsumer after) {
	...
	@Override
	@Deprecated
	default void accept(Byte k, Short v) { accept(k.byteValue(), v.shortValue()); }
	...
	@Override
	@Deprecated
	default ByteShortConsumer andThen(BiConsumer<? super Byte, ? super Short> after) {
		Objects.requireNonNull(after);
		return (K, V) -> {accept(K, V); after.accept(Byte.valueOf(K), Short.valueOf(V));};
	}
}