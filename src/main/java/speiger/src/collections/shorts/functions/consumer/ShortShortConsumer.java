 ...
 */
public interface ShortShortConsumer extends BiConsumer<Short, Short>
{
	/**
	 ...
	 */
	public default ShortShortConsumer andThen(ShortShortConsumer after) {
	...
	@Override
	@Deprecated
	default void accept(Short k, Short v) { accept(k.shortValue(), v.shortValue()); }
	...
	@Override
	@Deprecated
	default ShortShortConsumer andThen(BiConsumer<? super Short, ? super Short> after) {
		Objects.requireNonNull(after);
		return (K, V) -> {accept(K, V); after.accept(Short.valueOf(K), Short.valueOf(V));};
	}
}