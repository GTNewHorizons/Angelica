 ...
 */
public interface ShortObjectConsumer<V> extends BiConsumer<Short, V>
{
	/**
	 ...
	 */
	public default ShortObjectConsumer<V> andThen(ShortObjectConsumer<V> after) {
	...
	@Override
	@Deprecated
	default void accept(Short k, V v) { accept(k.shortValue(), v); }
	...
	@Override
	@Deprecated
	default ShortObjectConsumer<V> andThen(BiConsumer<? super Short, ? super V> after) {
		Objects.requireNonNull(after);
		return (K, V) -> {accept(K, V); after.accept(Short.valueOf(K), V);};
	}
}