...
public interface ShortFloatConsumer extends BiConsumer<Short, Float>
{
	 ...
	 */
	public default ShortFloatConsumer andThen(ShortFloatConsumer after) {
	...
	@Override
	@Deprecated
	default void accept(Short k, Float v) { accept(k.shortValue(), v.floatValue()); }
	...
	@Override
	@Deprecated
	default ShortFloatConsumer andThen(BiConsumer<? super Short, ? super Float> after) {
		Objects.requireNonNull(after);
		return (K, V) -> {accept(K, V); after.accept(Short.valueOf(K), Float.valueOf(V));};
	}
}