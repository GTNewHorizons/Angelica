...
public interface ShortByteConsumer extends BiConsumer<Short, Byte>
{
	 ...
	 */
	public default ShortByteConsumer andThen(ShortByteConsumer after) {
	...
	@Override
	@Deprecated
	default void accept(Short k, Byte v) { accept(k.shortValue(), v.byteValue()); }
	...
	@Override
	@Deprecated
	default ShortByteConsumer andThen(BiConsumer<? super Short, ? super Byte> after) {
		Objects.requireNonNull(after);
		return (K, V) -> {accept(K, V); after.accept(Short.valueOf(K), Byte.valueOf(V));};
	}
}