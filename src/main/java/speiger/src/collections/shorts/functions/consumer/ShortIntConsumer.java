...
public interface ShortIntConsumer extends BiConsumer<Short, Integer>
{
	 ...
	 */
	public default ShortIntConsumer andThen(ShortIntConsumer after) {
	...
	@Override
	@Deprecated
	default void accept(Short k, Integer v) { accept(k.shortValue(), v.intValue()); }
	...
	@Override
	@Deprecated
	default ShortIntConsumer andThen(BiConsumer<? super Short, ? super Integer> after) {
		Objects.requireNonNull(after);
		return (K, V) -> {accept(K, V); after.accept(Short.valueOf(K), Integer.valueOf(V));};
	}
}