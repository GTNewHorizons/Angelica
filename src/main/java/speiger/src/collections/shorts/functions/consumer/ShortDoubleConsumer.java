 ...
 */
public interface ShortDoubleConsumer extends BiConsumer<Short, Double>
{
	/**
	 ...
	 */
	public default ShortDoubleConsumer andThen(ShortDoubleConsumer after) {
	...
	@Override
	@Deprecated
	default void accept(Short k, Double v) { accept(k.shortValue(), v.doubleValue()); }
	...
	@Override
	@Deprecated
	default ShortDoubleConsumer andThen(BiConsumer<? super Short, ? super Double> after) {
		Objects.requireNonNull(after);
		return (K, V) -> {accept(K, V); after.accept(Short.valueOf(K), Double.valueOf(V));};
	}
}