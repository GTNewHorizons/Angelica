 ...
 */
public interface ShortBooleanConsumer extends BiConsumer<Short, Boolean>
{
	/**
	 ...
	 */
	public default ShortBooleanConsumer andThen(ShortBooleanConsumer after) {
	...
	@Override
	@Deprecated
	default void accept(Short k, Boolean v) { accept(k.shortValue(), v.booleanValue()); }
	...
	@Override
	@Deprecated
	default ShortBooleanConsumer andThen(BiConsumer<? super Short, ? super Boolean> after) {
		Objects.requireNonNull(after);
		return (K, V) -> {accept(K, V); after.accept(Short.valueOf(K), Boolean.valueOf(V));};
	}
}