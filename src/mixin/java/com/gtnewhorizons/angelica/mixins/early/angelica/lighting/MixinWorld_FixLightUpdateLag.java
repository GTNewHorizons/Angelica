...
public abstract class MixinWorld_FixLightUpdateLag {
    ...
    public void angelica$modifyUpdateRange(EnumSkyBlock p_147463_1_, int x, int y, int z,
    ...
    public int angelica$modifyRangeCheck2(int cst, @Share("updateRange") LocalIntRef updateRange) {
