...
public abstract class MixinRenderFish extends Render {
    ...
    public void doRender(EntityFishHook entity, double x, double y, double z, float p_76986_8_, float p_76986_9_) {
        ...
        GLMatrixManager.glTranslatef((float) x, (float) y, (float) z);
        GL11.glEnable(GL12.GL_RESCALE_NORMAL);
        GLMatrixManager.glScalef(0.5F, 0.5F, 0.5F);
        ...
        float f7 = 0.5F;
        float f8 = 0.5F;
        GLMatrixManager.glRotatef(180.0F - this.renderManager.playerViewY, 0.0F, 1.0F, 0.0F);
        GLMatrixManager.glRotatef(-this.renderManager.playerViewX, 1.0F, 0.0F, 0.0F);
