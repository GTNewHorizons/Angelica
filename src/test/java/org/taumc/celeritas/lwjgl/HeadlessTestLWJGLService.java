...
public final class HeadlessTestLWJGLService implements LWJGLService {

    public static HeadlessTestLWJGLService create() {
        return new HeadlessTestLWJGLService();
    }
    ...
    public void glBlitFramebuffer(int srcX0, int srcY0, int srcX1, int srcY1, int dstX0, int dstY0, int dstX1,
        ...
        throw new UnsupportedOperationException("glBlitFramebuffer requires a GL context");
    }

    @Override
    public void glDrawArrays(int mode, int first, int count) {
        throw new UnsupportedOperationException("glDrawArrays requires a GL context");
    }

    @Override
    public void glDrawBuffers(int[] buffers) {
        throw new UnsupportedOperationException("glDrawBuffers requires a GL context");
    }

    @Override
    public void glTexImage2D(int target, int level, int internalFormat, int width, int height, int border, int format,
        int type, ByteBuffer pixels) {
        throw new UnsupportedOperationException("glTexImage2D requires a GL context");
    }

    @Override
    public void glTexParameteri(int target, int pname, int param) {
        throw new UnsupportedOperationException("glTexParameteri requires a GL context");
    }
    ...
    public long nmemAlignedAlloc(long alignment, long size) {
        final long align = Math.max(alignment, 8L);
        final long base = MemoryUtilities.nmemAlloc(size + align + 8L);
        if (base == 0L) {
            return 0L;
        }
        long shift = align - (base % align);
        if (shift < 8L) {
            shift += align;
        }
        final long aligned = base + shift;
        MemoryUtilities.memPutLong(aligned - 8L, base);
        return aligned;
    }
    ...
    public void nmemAlignedFree(long ptr) {
        ...
        MemoryUtilities.nmemFree(MemoryUtilities.memGetLong(ptr - 8L));
    }
