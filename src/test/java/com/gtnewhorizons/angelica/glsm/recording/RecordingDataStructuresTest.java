...
class RecordingDataStructuresTest {
    ...
    void testImmediateModeRecorderCapturesQuads() {
        ...
        DirectTessellator result = recorder.end();
...
//        assertFalse(recorder.hasGeometry());
    ...
    void testImmediateModeRecorderCapturesTriangles() {
        ...
        DirectTessellator result = recorder.end();
        assertNotNull(result);
        assertEquals(6, result.getVertexCount());  // 2 triangles = 2 degenerate quads
    ...
    void testImmediateModeRecorderCapturesTriangleFan() {
        ...
        DirectTessellator result = recorder.end();
        assertNotNull(result);
        assertEquals(4, result.getVertexCount());  // 2 triangles from fan
    ...
    void testImmediateModeRecorderCapturesLines() {
        ...
        DirectTessellator result = recorder.end();
        assertNotNull(result);
        assertEquals(GL11.GL_LINES, result.drawMode, "Draw should use GL_LINES");
        assertEquals(4, result.getVertexCount(), "4 vertices for 2 lines");
    }
    ...
    void testImmediateModeRecorderCapturesLineStrip() {
        ...
        DirectTessellator result = recorder.end();
        assertNotNull(result);
        assertEquals(GL11.GL_LINE_STRIP, result.drawMode, "Draw should use GL_LINE_STRIP");
        assertEquals(4, result.getVertexCount(), "4 vertices for 2 lines");
    }
    ...
    void testImmediateModeRecorderCapturesLineLoop() {
        ...
        DirectTessellator result = recorder.end();
        assertNotNull(result);
        assertEquals(GL11.GL_LINE_LOOP, result.drawMode, "Draw should use GL_LINE_LOOP");
        assertEquals(4, result.getVertexCount(), "4 vertices for 2 lines");
    }
}
