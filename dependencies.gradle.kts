...
DependencyHandlerScope.of(dependencies).apply {
    ...
    runtimeOnlyNonPublishable("com.github.GTNewHorizons:BuildCraft:7.1.99:dev")
    runtimeOnlyNonPublishable("com.github.GTNewHorizons:Botania:1.13.99-GTNH:dev")
    runtimeOnlyNonPublishable("com.github.GTNewHorizons:LogisticsPipes:1.5.99-GTNH:dev")
    runtimeOnlyNonPublishable("com.github.GTNewHorizons:OpenComputers:1.12.99-GTNH:dev")
    ...
    runtimeOnlyNonPublishable("com.github.GTNewHorizons:Draconic-Evolution:1.5.99-GTNH:dev")
